<script lang="ts">
	...
	onMount(() => {
		...
		// Prevent default behavior for game control keys (space, arrows)
		keydownHandler = (e: KeyboardEvent) => {
			// Prevent default for space (32), up arrow (38), down arrow (40)
		...
		link.rel = 'stylesheet';
		link.href = '/trex/game.css';
		document.head.appendChild(link);

		// Load the JS and initialize the game
		const script = document.createElement('script');
		script.src = '/trex/game.js';
		script.onload = () => {
	...
	onDestroy(() => {
		// Stop any running game (browser only)
		if (browser) {
			const Runner = (window as any).Runner;
...
<svelte:head>
	<!-- Preload sprites -->
	<link rel="preload" href="{base}/trex-sprite.png" as="image" />
</svelte:head>
...
<div class="trex-wrapper">
	...
	<!-- Hidden sprite images that the game will reference -->
	<div id="offline-resources" style="display: none;">
		<img id="offline-resources-1x" src="/trex-sprite.png" alt="" />
		<img id="offline-resources-2x" src="/trex-sprite.png" alt="" />
	</div>

	<!-- Audio resources template for sound effects -->
...
<style>
	...
	:global(.offline .interstitial-wrapper) {
	...
	:global(.offline .icon-offline) {
		display: none !important;
	}

	:global(#main-frame-error) {
		display: none !important;
	}

	/* Disable arcade mode zoom behavior */
	:global(.arcade-mode) {
		image-rendering: auto !important;
	}

	:global(.arcade-mode .runner-container) {
		transform: none !important;
		transition: none !important;
	}

	:global(.arcade-mode .interstitial-wrapper) {
